Politique de confidentialité / RGPD — PixClean
Éditeur : Mr-Aurevo-X · Produit : PixClean
...
Nettoyage / édition de métadonnées d’images (EXIF, GPS, XMP) en local via Pillow.
Exécution locale (Python + WebView2). Préférences partagées possibles : %LOCALAPPDATA%\Mr-Aurevo-X\user-settings.json. Traitement image 100% local. L’original n’est pas modifié (copies _clean / _edited).
...
5. Contact
GitHub : https://github.com/Mr-Aurevo-X/PixClean
